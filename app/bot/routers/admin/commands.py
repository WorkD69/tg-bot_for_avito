...
async def cmd_commands(message: Message):
    text = (
        ...
        "/sourcestats [7d|30d] — источники пользователей (только регистрации)\n"
        "/sourcefunnel [7d|30d|today] — воронка регистрации→оплата→выручка по источнику\n"
        "/campaignstats [avito|tg_channel|direct] [7d|30d] — воронка по кампании\n\n"
        "— Выплаты операторам —\n"
